package in.hocg.payment.gateway.modules.bmw.helper.payment.resolve.message.rule.refund;
...
import in.hocg.payment.gateway.basic.constant.RefundStatus;
...
public class WxPayRefundMessageRule extends StringResolve.StringRule<PayRefundMessage, PayRefundMessage.Result> {
    ...
    protected static PayRefundMessage.Result handleMessage(PayRefundMessage message, Map<String, Object> args) {
        try {
            ...
            SpringContext.getBean(in.hocg.payment.gateway.modules.bmw.service.PaymentService.class).handleRefundMessage(ro);
